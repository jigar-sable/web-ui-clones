...
.then(videos => {
    ...
    videos.forEach(video => {
        ...
        <a href="${video.videoURL}">
            ...
            <img class="relative h-full w-full object-cover" src="${video.thumbnail}" alt="">
        ...
        <div class="flex items-center space-x-3">
            <!-- channel logo -->
            <a href="${video.desc.channelURL}" class="rounded-full w-12 sm:w-14"><img class="w-full h-full rounded-full object-cover" src="${video.desc.channelLogo}" alt=""></a>
        ...
        <div class="flex flex-col pl-1 sm:pl-0 ml-12">
            ...
            <div class="flex space-x-1">
                <span class="text-sm text-gray-400">${video.desc.views}</span>
                <span class="text-sm text-gray-400">• ${video.desc.published}</span>
            </div>
        </div>
        </div>
    </div>`
