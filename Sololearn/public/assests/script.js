...
.then(courses => {
    ...
    courses.forEach(course => {
        ...
        <img class="w-full h-full rounded-full border object-cover" src="assests/images/courses/${course.id}.png" alt="" srcset="" draggable="false">
        </div>
